...
public partial class Apply : BasePage
{
    ...
    {
        CandidateData objCandD = new CandidateData();
        DataTable dt = objCandD.get_sub_cat(reqid);
        ...
        if (chk_decl.Checked)
        {
            ...
            if (NoncreamylayerDATE != "")
            {
                ...
                else
                {
                    ...
                    msg.Show("Issuing date must be prior to the cut-off date of advertisement");
                }
            }
            ...
            if (DropDownList_cat.SelectedItem.Text == "Select")
            {
                msg.Show(" Select category");
            }
            if (CheckBoxList_Subcategory.SelectedValue == "PH")//check box for Differentially Able
            {
            ...
            if (CheckBoxList_Subcategory.SelectedValue == "CESD")
            {
                if (ViewState["PhDoc"] == "")
                {
            ...
            else if ((DropDownList_cat.SelectedValue == "OBC" || DropDownList_cat.SelectedValue == "SC" || DropDownList_cat.SelectedValue == "ST") && (txtbox_noncreamylayer.Text == "" || txtbox_noncreamylayerDATE.Text == "" || DropDownList_c_state.SelectedValue == "-1"))
            {
                msg.Show("Please fill the Non Creamy Layer Certificate No,Certificate Issue Date and State");
            }
            ...
            else
            {
                ...
                if (sub_cat.Length > 0)
                {
                    sub_cat = sub_cat.Substring(0, sub_cat.Length - 1);
                }
                cat_subcat = DropDownList_cat.SelectedValue;
                if (sub_cat != "")
                {
                    cat_subcat = DropDownList_cat.SelectedValue + "," + sub_cat;
                }
                check_fee_relax(cat_subcat);
                check_fee_relax_female(RadioButtonList_mf.SelectedValue);
                ...
                if (ex_grpC_flag == true)
                {
                    ...
                    //}
                    DOB_from_date = DateTime.ParseExact(lbl_dob_f.Text, "dd/MM/yyyy", new CultureInfo("en-US")).AddYears(0 - Yr).AddDays(0 - length_ex_serv);

                }
                else
                {
                    Yr = Yr + Yscat;
                    DOB_from_date = DateTime.ParseExact(lbl_dob_f.Text, "dd/MM/yyyy", new CultureInfo("en-US")).AddYears(0 - Yr);
                }
                ...
                if (Yu > 0)
                {
                    ...
                    if (Yu <= age && (DropDownList_cat.SelectedValue == "UR" || DropDownList_cat.SelectedValue == "EWS"))
                    {
                        if (age == Yu)
                        {
                            if (months > 0 || days > 0)
                    ...
                    else if (DropDownList_cat.SelectedValue == "SC" || DropDownList_cat.SelectedValue == "ST" || DropDownList_cat.SelectedValue == "OBC")
                    {
                        Yu = Yr;
                        if (Yu <= age)
                        {
                    ...
                    if (ph_scrib_chk(ph_flag, ph_scrib))
                    {
                        if (check_debar_PH(ph) && check_debar_sub_ph_all())
                        {
                            if (check_debar_flag)
                            {
                                if (check_issue_date_flag)
                                {
                                    if (check_age(DOB_date, DOB_from_date, DOB_to_date, txt_cont.Text) || agevalidationexmpt == "Y")
                                    {
                                        ...
                                        if (dt.Rows.Count == 0)
                                        {
                                            ...
                                            //
                                            if (CheckBoxList_Subcategory.SelectedValue == "EX")
                                            {
                                                ex = "Y";
                                            }
                                ...
                                {
                                    msg.Show("Certificate Issue date should be earlier than Advt. End Date.");
                                }
                            }
                            else
                            {
    ...
    protected void DropDownList_cat_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (DropDownList_cat.SelectedItem.Text == "OBC" || DropDownList_cat.SelectedItem.Text == "SC" || DropDownList_cat.SelectedItem.Text == "ST" || DropDownList_cat.SelectedItem.Text == "EWS")
        {
            ...
            {
                lbl_issuing_no.Text = "Non-Creamy Layer Certificate No.";
                lbl_issuing_date.Text = "Issuing Date";
                lbl_issuing_state.Text = "Certificate Issuing State";
                rbtobcregion.Visible = true;
            }
            else if (DropDownList_cat.SelectedItem.Text == "SC")
            {
                lbl_issuing_no.Text = "SC Certificate No.";
                lbl_issuing_date.Text = "Issuing Date";
                lbl_issuing_state.Text = "Certificate Issuing State";
            ...
            {
                lbl_issuing_no.Text = "ST Certificate No.";
                lbl_issuing_date.Text = "Issuing Date";
                lbl_issuing_state.Text = "Certificate Issuing State";
                rbtobcregion.Visible = false;
            }
            ...
            {
                lbl_issuing_no.Text = "EWS Certificate No.";
                lbl_issuing_date.Text = "Issuing Date";
                lbl_issuing_state.Text = "Certificate Issuing State";
                rbtobcregion.Visible = false;
            }
    ...
    protected void btn_update_Click(object sender, EventArgs e)
    {
        ...
        if (DropDownList_cat.SelectedItem.Text == "Select")
        {
            msg.Show("Please select category");
        }
        if (CheckBoxList_Subcategory.SelectedValue == "PH")//check box for Differentially Able
        {
            if (CheckboxList_PHSubCat.SelectedValue == "")
        ...
        else if (chk_decl.Checked)
        {
            ...
            {
                if (txtbox_noncreamylayerDATE.Text == "")
                    msg.Show("Please fill the Non Creamy Layer Date");
                else if (DropDownList_c_state.SelectedValue == "-1")
                    msg.Show("Please fill the Non Creamy Layer State");
            }
            if (txtbox_noncreamylayerDATE.Text != "")
            {
                DateTime issue_date = DateTime.ParseExact(txtbox_noncreamylayerDATE.Text, "dd/MM/yyyy", new CultureInfo("en-US"));
                    ...
                    if (check_debar_PH(ph) && check_debar_sub_ph_all())
                    {
                        if (check_issue_date_flag)
                        {
                            if (check_age(DOB_date, DOB_from_date, DOB_to_date, txt_cont.Text) || agevalidationexmpt == "Y")
                            {
                                if (check_debar_flag)
                                {
                                    if (NoncreamylayerDATE != "")//20-02-2023
                                    {
                                ...
                                {
                                    msg.Show("Certificate issue date must be prior to actual advertisement date");//28-02-2023
                                }
                               else//01-03-2023
                                {
                                    string url_photo = md5util.CreateTamperProofURL("jobupload.aspx", null, "applid=" + MD5Util.Encrypt(applid.ToString(), true));
                        ...
                        {
                            msg.Show("Certificate Issue date should be or earlier than today Date.");
                        }
                    }
                }
                else
    ...
    protected void CheckBoxList_Subcategory_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < CheckBoxList_Subcategory.Items.Count; i++)
        {
            ...
            if (gender == "male" && checkValue == "WD" && isSelected || gender == "male" && checkValue == "WOOB" && isSelected || gender == "male" && checkValue == "WOSC" && isSelected)
            {
    ...
    private bool check_debar_PH(string ph)
    {
        ...
        else
        {
            ...
            DataTable dt = objCandD.check_debar_PH(ph, jid);
            if (dt.Rows.Count == 0)
            {
    ...
    private bool check_debar_Sub_PH(string sub_ph)
    {
        ...
        else
        {
            ...
            DataTable dt = objCandD.check_debar_sub_PH(sub_ph, jid);
            if (dt.Rows.Count == 0)
            {
                msg.Show("You are not eligible to apply for this Post due to the category of your Disability.");
                return false;
    ...
    protected void CheckboxList_PHSubCat_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        bool scribe_flag = false; int lastSelectedIndex = 0;
    ...
    private void check_fee_relax(string cat_subcat)
    {
        DataTable dt = new DataTable();
    ...
    private void check_fee_relax_female(string gender)
    {
        DataTable dt = new DataTable();
