                                                                    ...
                                                                    <td colspan="5">
                                                                        ...
                                                                        <table width="100%" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" colspan="1">
                                                                                    <asp:TextBox ID="txtExToDt" runat="server"   TabIndex="30" Width="80px"
                                                                            ...
                                                                            <ContentTemplate>--%>
                                                                                <table width="100%" border="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" colspan="1">
                                                                                            <asp:TextBox ID="txtDebardYr" runat="server"   TabIndex="2" Width="60px"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="left">
                                                                                                            <asp:RadioButtonList ID="rbGovtEmployee" runat="server" RepeatDirection="Horizontal"
                                                                                                                TabIndex="31" CssClass="ariallightgrey" AutoPostBack="True" 
                                                                                                                meta:resourcekey="rbGovtEmployeeResource1" onselectedindexchanged="rbGovtEmployee_SelectedIndexChanged" 
                                                                                                               >
                                                                                                                <asp:ListItem Value="true" meta:resourcekey="ListItemResource23">Yes</asp:ListItem>
                                                                                                                <asp:ListItem Value="false" Selected="True" meta:resourcekey="ListItemResource24">No</asp:ListItem>
                                                                                                            </asp:RadioButtonList>                                                                                                        </td>
                                                                                                        <td align="left" colspan="1">
                                                                                                        ...
                                                                                                        <td align="left" colspan="1">
                                                                                                            <asp:TextBox ID="txtGovtJoinDt" runat="server"   TabIndex="32" Width="80px"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="left">
                                                                                                            <asp:RadioButtonList ID="rbFeder" runat="server" RepeatDirection="Horizontal" TabIndex="33"
                                                                                                                CssClass="ariallightgrey" AutoPostBack="True" 
                                                                                                                meta:resourcekey="rbFederResource1" 
                                                                                                                onselectedindexchanged="rbFeder_SelectedIndexChanged" 
                                                                                                                CausesValidation="True">
                                                                                                                <asp:ListItem Value="true" meta:resourcekey="ListItemResource25">Yes</asp:ListItem>
                                                                                                                <asp:ListItem Value="false" Selected="True" meta:resourcekey="ListItemResource26">No</asp:ListItem>
                                                                                                            </asp:RadioButtonList>                                                                                                        </td>
                                                                                                        <td colspan="2">                                                                                                        </td>
                                                                                                    </tr>
                                                                                              </table>                                                                                            </td>
...
<asp:Panel ID="panEdu" runat="server">                                              
                                                        ...
                                                        <table bgcolor="#d2e2b7" border="0" cellpadding="1" cellspacing="0" class="greydotRED"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="trFloral">
                                                                    <td align="left">
                                                                        <asp:DropDownList ID="ddlEdu" AutoPostBack="True" runat="server"  
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtEduOther" runat="server"   Width="120px" Visible="False"
                                                                            meta:resourcekey="txtEduOtherResource1"></asp:TextBox>
                                                                    </td>
                                                                    <td align="left" colspan="1">
                                                                        <asp:TextBox ID="txtPerc3" runat="server"   TabIndex="54" MaxLength="5"
                                                                    ...
                                                                    <td align="left" colspan="1">
                                                                        <asp:DropDownList ID="ddlClass3" runat="server" Font-Names="Arial Unicode MS"
                                                                    ...
                                                                    <td align="left" colspan="1">
                                                                        <asp:TextBox ID="txtBoard3" runat="server"   TabIndex="56" Width="100px"
                                                                    ...
                                                                    <td align="left" colspan="1">
                                                                        <asp:TextBox ID="txtState3" runat="server"   TabIndex="57" Width="100px"
                                                                            Text=""></asp:TextBox>
                                                                    ...
                                                                    <td align="left" colspan="1">
                                                                        <asp:TextBox ID="txtYear3" MaxLength="4" runat="server"   TabIndex="58"
                                                                ...
                                                                <%--<tr class="trFloral" id="edu4" runat="server" visible="false">
                                                                    <td id="Td1" align="left" colspan="2" runat="server">
                                                                        <asp:DropDownList ID="ddlEdu4" AutoPostBack="false" runat="server"  
                                                                            Font-Names="Arial Unicode MS" TabIndex="60">
                                                                        </asp:DropDownList>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator165" ControlToValidate="ddlEdu4"
                                                                            runat="server" SetFocusOnError="True" InitialValue="0" ErrorMessage="Education Qualification - Education Details">*</asp:RequiredFieldValidator>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEduOther4" runat="server"   TabIndex="61" Width="120px"
                                                                            Visible="False"></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td2" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtPerc4" runat="server"   TabIndex="62" MaxLength="5"
                                                                    ...
                                                                    <td id="Td3" align="left" colspan="1" runat="server">
                                                                        <asp:DropDownList ID="ddlClass4" runat="server"   Font-Names="Arial Unicode MS"
                                                                    ...
                                                                    <td id="Td4" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtBoard4" runat="server"   TabIndex="64" Width="100px"
                                                                    ...
                                                                    <td id="Td5" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtState4" runat="server"   TabIndex="65" Width="100px"
                                                                            Text=""></asp:TextBox>
                                                                    ...
                                                                    <td id="Td6" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtYear4" MaxLength="4" runat="server"   TabIndex="66"
                                                                ...
                                                                <tr class="trFloral" id="edu5" runat="server" visible="False">
                                                                    <td id="Td7" align="left" colspan="2" runat="server">
                                                                        <asp:DropDownList ID="ddlEdu5" AutoPostBack="false" runat="server"  
                                                                            Font-Names="Arial Unicode MS" TabIndex="67">
                                                                        </asp:DropDownList>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEduOther5" runat="server"   TabIndex="68" Width="120px"
                                                                            Visible="False"></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td8" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtPerc5" runat="server"   TabIndex="69" MaxLength="5"
                                                                            Width="70px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td9" align="left" colspan="1" runat="server">
                                                                        <asp:DropDownList ID="ddlClass5" runat="server"   Font-Names="Arial Unicode MS"
                                                                            TabIndex="70" Width="150px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td id="Td10" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtBoard5" runat="server"   TabIndex="71" Width="100px"
                                                                            Text="University"></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td11" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtState5" runat="server"   TabIndex="72" Width="100px"
                                                                            Text=""></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td12" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtYear5" MaxLength="4" runat="server"   TabIndex="73"
                                                                            Width="100px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral" id="edu6" runat="server" visible="False">
                                                                    <td id="Td13" align="left" colspan="2" runat="server">
                                                                        <asp:DropDownList ID="ddlEdu6" AutoPostBack="false" runat="server"  
                                                                            Font-Names="Arial Unicode MS" TabIndex="74">
                                                                        </asp:DropDownList>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEduOther6" runat="server"   TabIndex="75" Width="120px"
                                                                            Visible="False"></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td14" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtPerc6" runat="server"   TabIndex="76" MaxLength="5"
                                                                            Width="70px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td15" align="left" colspan="1" runat="server">
                                                                        <asp:DropDownList ID="ddlClass6" runat="server"   Font-Names="Arial Unicode MS"
                                                                            TabIndex="77" Width="150px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td id="Td16" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtBoard6" runat="server"   TabIndex="78" Width="100px"
                                                                            Text="University"></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td17" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtState6" runat="server"   TabIndex="79" Width="100px"
                                                                            Text=""></asp:TextBox>
                                                                    </td>
                                                                    <td id="Td18" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtYear6" MaxLength="4" runat="server"   TabIndex="80"
                                                                            Width="100px"></asp:TextBox>
                                                                    </td>
                                                                </tr>--%>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="trFloral">
                                                                    ...
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtPost1" runat="server"   TabIndex="53" Width="120px"
                                                                    ...
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpName1" runat="server"   TabIndex="56" Width="130px"
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpContact1" runat="server"   TabIndex="57"
                                                                    ...
                                                                    <td align="left" colspan="1">
                                                                        <asp:TextBox ID="txtEmpAddr1" runat="server"   TabIndex="58" Width="130px"
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpPin1" runat="server"   TabIndex="59" Width="100px"
                                                                    ...
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpSal1" runat="server"   TabIndex="58" Width="130px"
                                                                            meta:resourcekey="txtEmpAddr1Resource1"></asp:TextBox><br />
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral" id="trExper2" visible="False" runat="server">
                                                                    ...
                                                                    <td id="Td20" align="left" colspan="1" style="width: 233px" valign="top" runat="server">
                                                                        <asp:TextBox ID="txtPost2" runat="server"   TabIndex="60" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td id="Td23" align="left" colspan="1" valign="top" runat="server">
                                                                        <asp:TextBox ID="txtEmpName2" runat="server"   TabIndex="63" Width="130px"></asp:TextBox>
                                                                       <%-- <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender4" runat="server" TargetControlID="txtEmpName2"
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpContact2" runat="server"   TabIndex="64"
                                                                            Width="100px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td24" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpAddr2" runat="server"   TabIndex="65" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender6" runat="server" TargetControlID="txtEmpAddr2"
                                                                            WatermarkText="Emp Name Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpPin2" runat="server"   TabIndex="66" Width="100px"
                                                                            MaxLength="6"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender7" runat="server" TargetControlID="txtEmpPin2"
                                                                            WatermarkText="PIN CODE" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                    </td>
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpSal2" runat="server"   TabIndex="58" Width="130px"
                                                                            meta:resourcekey="txtEmpAddr1Resource1"></asp:TextBox><br />
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral" id="trExper3" visible="False" runat="server">
                                                                    ...
                                                                    <td id="Td26" align="left" colspan="1" style="width: 233px" valign="top" runat="server">
                                                                        <asp:TextBox ID="txtPost3" runat="server"   TabIndex="67" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td id="Td29" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpName3" runat="server"   TabIndex="70" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender8" runat="server" TargetControlID="txtEmpName3"
                                                                            WatermarkText="Emp Name Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpContact3" runat="server"   TabIndex="71"
                                                                            Width="100px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td30" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpAddr3" runat="server"   TabIndex="72" Width="130px"></asp:TextBox>
                                                                       <%-- <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender10" runat="server" TargetControlID="txtEmpAddr3"
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpPin3" runat="server"   TabIndex="73" Width="100px"
                                                                            MaxLength="6"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender11" runat="server" TargetControlID="txtEmpPin3"
                                                                            WatermarkText="PIN CODE" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                    </td>
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpsal3" runat="server"   TabIndex="58" Width="130px"
                                                                            meta:resourcekey="txtEmpAddr1Resource1"></asp:TextBox><br />
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral" id="trExper4" visible="False" runat="server">
                                                                    ...
                                                                    <td id="Td32" align="left" colspan="1" style="width: 233px" valign="top" runat="server">
                                                                        <asp:TextBox ID="txtPost4" runat="server"   TabIndex="74" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td id="Td35" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpName4" runat="server"   TabIndex="77" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender12" runat="server" TargetControlID="txtEmpName4"
                                                                            WatermarkText="Emp Name Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpContact4" runat="server"   TabIndex="78"
                                                                            Width="100px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td36" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpAddr4" runat="server"   TabIndex="79" Width="130px"></asp:TextBox>
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpPin4" runat="server"   TabIndex="80" Width="100px"
                                                                            MaxLength="6"></asp:TextBox>
                                                                       <%-- <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender19" runat="server" TargetControlID="txtEmpPin4"
                                                                            WatermarkText="PIN CODE" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                    </td>
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpSal4" runat="server"   TabIndex="58" Width="130px"
                                                                            meta:resourcekey="txtEmpAddr1Resource1"></asp:TextBox><br />
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral" id="trExper5" visible="False" runat="server">
                                                                    ...
                                                                    <td id="Td38" align="left" colspan="1" style="width: 233px" valign="top" runat="server">
                                                                        <asp:TextBox ID="txtPost5" runat="server"   TabIndex="81" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td id="Td41" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpName5" runat="server"   TabIndex="84" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender13" runat="server" TargetControlID="txtEmpName5"
                                                                            WatermarkText="Emp Name Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpContact5" runat="server"   TabIndex="85"
                                                                            Width="100px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td42" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpAddr5" runat="server"   TabIndex="86" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender18" runat="server" TargetControlID="txtEmpAddr5"
                                                                            WatermarkText="Address Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpPin5" runat="server"   TabIndex="87" Width="100px"
                                                                            MaxLength="6"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender20" runat="server" TargetControlID="txtEmpPin5"
                                                                            WatermarkText="PIN CODE" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                    </td>
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpSal5" runat="server"   TabIndex="58" Width="130px"
                                                                            meta:resourcekey="txtEmpAddr1Resource1"></asp:TextBox><br />
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral" id="trExper6" visible="False" runat="server">
                                                                    ...
                                                                    <td id="Td44" align="left" colspan="1" style="width: 233px" valign="top" runat="server">
                                                                        <asp:TextBox ID="txtPost6" runat="server"   TabIndex="88" Width="120px"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td id="Td47" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpName6" runat="server"   TabIndex="91" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender14" runat="server" TargetControlID="txtEmpName6"
                                                                            WatermarkText="Emp Name Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpContact6" runat="server"   TabIndex="92"
                                                                            Width="100px"></asp:TextBox>
                                                                    ...
                                                                    <td id="Td48" align="left" colspan="1" runat="server">
                                                                        <asp:TextBox ID="txtEmpAddr6" runat="server"   TabIndex="93" Width="130px"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender22" runat="server" TargetControlID="txtEmpAddr6"
                                                                            WatermarkText="Address Here" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                        <br />
                                                                        <asp:TextBox ID="txtEmpPin6" runat="server"   TabIndex="94" Width="100px"
                                                                            MaxLength="6"></asp:TextBox>
                                                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender23" runat="server" TargetControlID="txtEmpPin6"
                                                                            WatermarkText="PIN CODE" WatermarkCssClass="watermarked" Enabled="True" />--%>
                                                                    </td>
                                                                    <td align="left" colspan="1" valign="top">
                                                                        <asp:TextBox ID="txtEmpSal6" runat="server"   TabIndex="58" Width="130px"
                                                                            meta:resourcekey="txtEmpAddr1Resource1"></asp:TextBox><br />
                                                                    </td>
                                                                </tr>
                                                                <tr class="trFloral">
