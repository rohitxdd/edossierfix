...
public partial class Apply : BasePage
{
    ...
    protected void btn_insert_Click(object sender, EventArgs e)
    {
        ...
        //14/08/2023
        if (lbl_post_code.Text == "62/23" && (DropDownList_cat.SelectedItem.Text == "OBC" || DropDownList_cat.SelectedItem.Text == "EWS" || DropDownList_cat.SelectedItem.Text == "UR"))
        {
        ...
        if (chk_decl.Checked)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < CheckBoxList_Subcategory.Items.Count; i++)
                {
                    if (CheckBoxList_Subcategory.Items[i].Selected)
                    {
                        ...
                        if (subcat[i] != null)
                        {
                            ...
                            if (subcat[i] == "EX" || subcat[i] == "ExSM")//14/08/2023
                            {
                                ex_grpC_flag = true;
                            }
                        }
                ...
                if (ex_grpC_flag == true)
                {
                    ...
                    //else
                    //{
                  if (CheckBoxList_Subcategory.SelectedValue == "EX")//14/08/2023
                {
                ...
                else
                {
                    ...
                    if (DropDownList_cat.SelectedValue == "OBC" && rbtobcregion.SelectedValue == "O")
                    {
    ...
    protected void DropDownList_cat_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (DropDownList_cat.SelectedItem.Text == "OBC" || DropDownList_cat.SelectedItem.Text == "SC" || DropDownList_cat.SelectedItem.Text == "ST" || DropDownList_cat.SelectedItem.Text == "EWS")
        {
            ...
            if (DropDownList_cat.SelectedItem.Text == "OBC")
            {
                ...
                lbl_issuing_date.Text = "Issuing Date (Before Cut-Off Date)";
    ...
    protected void CheckBoxList_Subcategory_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < CheckBoxList_Subcategory.Items.Count; i++)
        {
            ...
            if (gender == "male" && checkValue == "WD" && isSelected || gender == "male" && checkValue == "WOOB" && isSelected || gender == "male" && checkValue == "WOSC" && isSelected || gender=="male" && checkValue == "WC" && isSelected)//14/08/2023
            {
