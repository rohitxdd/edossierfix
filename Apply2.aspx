    ...
    <table style="width: 110%" border="0" cellpadding="0" cellspacing="0" align="left">
                                ...
                                <tr align="left">
                                    ...
                                    <td style="width: 70%">
                                        ...
                                        <asp:RegularExpressionValidator ID="REF_PreAdd" runat="server" ControlToValidate="txt_pre_add"
                                            Display="None" ErrorMessage="Invaild Characters in Present Address  or Address length is more than 200 Characters"
                                            ValidationExpression="^[0-9a-zA-Z-#(),./\s]{1,200}$" ValidationGroup="1"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr align="left">
                                    <td>
                                ...
                                <tr align="left">
                                    ...
                                    <td style="width: 70%">
                                        ...
                                        <asp:RegularExpressionValidator ID="REV_parmaAdd" runat="server" ControlToValidate="txt_par_add"
                                            Display="None" ErrorMessage="Invaild Characters in Permanent Address or Address length is more than 200 Characters"
                                            ValidationExpression="^[0-9a-zA-Z-#(),./\s]{1,200}$" ValidationGroup="1"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr align="left">
        ...
        <tr id="tr_obc_cert" runat="server" visible="false">
            ...
            <td style="width: 257px" align="left">
                <asp:TextBox ID="txtbox_noncreamylayer" runat="server" Width="90%" MaxLength="20"></asp:TextBox>
        ...
        <tr id="tr_obc_cert_f" runat="server" visible="false">
            ...
            <td style="width: 257px" align="left">
                <asp:TextBox ID="txtbox_noncreamylayer_f" runat="server" Width="90%" MaxLength="20"></asp:TextBox>
