<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Experience.aspx.cs" Inherits="Experience" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="Server">
    ...
    <table width="100%">
        ...
        <tr >
            <td>
<%--                <asp:RadioButtonList ID="rbtquali" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" Style="display:block; width:900px; word-wrap:break-word"
                    OnSelectedIndexChanged="rbtquali_SelectedIndexChanged" CssClass="formheading" onclick="return confirmSelection();">
                </asp:RadioButtonList>--%>
