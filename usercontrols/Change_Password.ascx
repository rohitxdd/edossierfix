<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Change_Password.ascx.cs" Inherits="usercontrols_Change_Password" %>
                ...
                <tr class="darkblue">
                    <td >
                        <table border="1" id="TABLE1" class="darkblue" align="center">
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="NewPassword"
                                        ControlToValidate="ConfirmNewPassword" Display="none" ErrorMessage="Confirm Password match the New Password"
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                   <asp:Button ID="ChangePasswordButton" runat="server" BackColor="White" ForeColor="#284E98" Text="Change Password" UseSubmitBehavior="true" ValidationGroup="1" OnClick="ChangePasswordButton_Click" OnClientClick="return SignValidate();" Width="125px"/>
                                </td>
                               <%-- <td>
