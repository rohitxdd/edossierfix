...
{ 
 ...
 <table border="0"  width="100%" class="validatorstyles" align="center">
                <tr>
                    <td >
                        <table border="1" id="TABLE1" class="validatorstyles" align="center">
                            ...
                            <tr>
                                ...
                                <td style="width: 300px" align="left">
                                    <asp:TextBox ID="ConfirmNewPassword" MaxLength="16" runat="server" Font-Size="0.8em" autocomplete="off" TextMode="Password" AutoCompleteType="None" autofill="false" EnableViewState="True" style="left: 3px; position: relative; top: 0px"  Width="150px"></asp:TextBox>&nbsp;
                                    <asp:RegularExpressionValidator
                                        ID="refconpwd" runat="server" ControlToValidate="ConfirmNewPassword"
                                        Display="None" ErrorMessage="Confirm New Password must be of atleast 6 characters or there are some Invalid Charachers" ValidationExpression="^[a-zA-Z0-9!$%^*@#&]{6,}$"
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="NewPassword"
                                        ControlToValidate="ConfirmNewPassword" Display="none" ErrorMessage="Confirm Password should match the New Password"
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                   <asp:Button ID="ChangePasswordButton" runat="server" BackColor="White" ForeColor="#284E98" Text="Change Password" UseSubmitBehavior="true" ValidationGroup="1" OnClick="ChangePasswordButton_Click" OnClientClick="return SignValidate();"/>
                                </td>
                               <%-- <td>
